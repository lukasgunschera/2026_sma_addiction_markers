...
## Function: retest_predictive_performance ===================================================================================
...
retest_predictive_peformance <- function(predicted_session_data,
  ...
  for (subj in unique(predicted_session_data$subj_id)) {
    ...
    subj_dat <- predicted_session_data[predicted_session_data$subj_id == subj, ]
    prediction_acc <- c()
  ...
  all_prediction_res <- data.frame(
    "subj" = predicted_session_data$subj_id,
    "trial" = rep(1:64, 30),
